#+TAGS: Paper | Book
* To Read
** TODO An Algorithm for Differential File Comparison                :Paper:
:PROPERTIES:
:CATEGORY: Programming
:Date_Added: <2019-10-27>
:END:
*** Source
Link: https://nanohub.org/infrastructure/rappture/export/3582/trunk/gui/src/diff.pdf
File: pdftools:./[[pdfs/An-Algorithm-for-Differential-File-Comparison.pdf]]
*** Notes
file:An-Algorithm-for-Differential-File-Comparison.org
** TODO [#A] Frameworks and Why (Clojure) Programmers Need Them      :Paper:
:PROPERTIES:
:CATEGORY: Programming
:Date_Added: <2019-08-12>
:END:
Link http://flyingmachinestudios.com/programming/why-programmers-need-frameworks/
** TODO [#A] Rust flow
:PROPERTIES:
:CATEGORY: Programming
...
** TODO [#A] One Monad to Prove Them All                             :Paper:
:PROPERTIES:
:CATEGORY: Programming
...
*** Thoughts
* To Listen
** DONE [#A] Exploring Dynamicland: Omar Rizwan
:PROPERTIES:
:CATEGORY: Programming
:Date_Added: <2018-08-30 Thu>
:END:
...
:PROPERTIES:
:CATEGORY: Programming
:Date_Added: <2019-10-27 Thu>
:END:
Link: https://www.youtube.com/watch?v=Dtn9Uudw4Mo
*** Source
https://twitter.com/tenderlove/status/1188335781770752004
